                                ...
                                <div class="form-base_row">
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="ico" type="text" id="txtLegalICO" class="form-control" maxlenglabel="20">
                                ...
                                <div class="form-base_row">
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="companyName" type="text" maxlength="100" id="txtLegalName" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="dic" type="text" id="txtLegalDIC" class="form-control" maxlenglabel="20">
                                ...
                                <div class="form-base_row">
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="street" type="text" maxlength="100" id="txtLegalStreet" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="city" type="text" maxlength="100" id="txtLegalCity" class="form-control">
                                ...
                                <div class="form-base_row">
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="zip" type="text" maxlength="7" id="txtLegalZip" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <select wire:model.defer="country" id="MainContent_ddLegalCountry" class="form-control">
                                ...
                                <div class="form-base_row">
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="firstName" type="text" maxlength="20" id="txtPersonFName" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="lastName" type="text" maxlength="100" id="txtPersonLName" class="form-control">
                                ...
                                <div class="form-base_row form-base_row--align-v-top">
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="phone" type="text" maxlength="20" id="txtLegalTel" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="email" type="text" maxlength="100" id="txtLegalEmail" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="password" type="password" maxlength="100" id="password" class="form-control">
                                    ...
                                    <div class="form-base_item">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.defer="confirm_password" type="password" maxlength="100" id="confirm_password" class="form-control">
                            ...
                            <div class="form-base">
                                <div class="form-base_item">
                                    <div class="form-group">
                                        ...
                                        <textarea wire:model.defer="note" rows="4" cols="20" id="txtLegalNote" class="form-control"></textarea>
