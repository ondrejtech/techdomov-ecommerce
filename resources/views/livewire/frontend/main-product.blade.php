<section class="products-catalog">
    <div class="grid-wrapper data-product-items">
        @foreach($laptops['data'] as $laptop)
            <article id="product_1713260" class="product-item pro-tile">
                <div class="pro-tile_in">
                    <a class="js-html5-storage" style="color: black; text-align: center" href="{{ route('product.view', ['CategoryCode' => $laptop->CategoryCode, 'ProId' => $laptop->ProId]) }}">
                    {{ $laptop->Name }}
                    </a>
                    ...
                    <figure class="pro-tile_img">
                        <a class="js-html5-storage" href="">
                            <img class="pro-img b-lazy b-loaded" alt="{{ $laptop->Name }}" src="{{ optional($laptop->images->first())->URL ?? asset('images/no_image.jpg') }}">
                        </a>
                    </figure>
                    <div class="pro-tile_hover-box">
                        <div class="pro-tile_desc product-desc">
                            <div class="pro-tile_desc_in">
                                {{ $laptop->DescriptionShort }}
                            </div>
                        </div>
                    ...
                    <div class="pro-tile_footer">
                        <div class="pro-tile_footer-in">
                            ...
                            <div class="pro-tile_order-box">
                                ...
                                <div class="btn-group" wire:click="addNewBasket({{ $laptop->ProId }})">
