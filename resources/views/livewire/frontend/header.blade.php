...
{{--                        <span itemprop="legalName" class="hide-common-user text-hidden-desc">eD system a.s.</span>--}}
            ...
            <div id="searchForm_wrap" class="page-header_item search-form-wrap">
                <form id="searchForm" class="search-form validate" role="search" aria-label="Vyhledávání" action="/pages/productlist.aspx" novalidate="novalidate">
                    <div class="search-form_in">
                        <div class="input-group">
                            <span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span><input type="search" value="" name="fulltext" id="quick_search_fulltext" class="form-control search-form_field ui-autocomplete-input" placeholder="Hledaný výraz nebo kód produktu" data-rule-required="true" data-msg-required="Zadejte prosím nejméně 2 znaky." data-msg-minlength="Zadejte prosím nejméně 2 znaky." data-rule-minlength="2" autocomplete="off" aria-required="true">
                    ...
                    <span class="search-form_info-icon js-tooltip" data-hasqtip="0" oldtitle="Zadaný výraz hledá přes kód produktu, id produktu, název produktu, výrobce, kategorii" title=""><i class="icon-info"></i></span>
                </form>
            </div>
                ...
                <div class="page-header_item">
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle user-info" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="btn_label user-info_label">
											<strong class="user-info_name js-tooltip js-tooltip--top-left" title="Ondrej Zelina ">{{ auth()->user()->name." ".auth()->user()->surname." | " }}</strong>
                                ...
                                <div class="dropdown-menu_in">
                                    <ul class="dropdown-menu-group">
                                        <li class="dropdown-item-wrap dropdown-item-wrap--user-logout visible-touch">
                                            <a href="#" wire:click.prevent="logout" class="dropdown-item dropdown-item--user-logout" title="Odhlásit">
                                                <i class="icon-logout dropdown-item_icon"></i>
                                                <span class="dropdown-item_label">Odhlásit</span>
                                            </a>
                                        </li>
                                        <li class="dropdown-item-wrap"><a class="dropdown-item dropdown-item--highlight" href="{{ route('admin.dashboard')}}"><span class="dropdown-item_label">Můj přehled</span></a></li>
                                        ...
                                        <li class="dropdown-item-wrap"><a class="dropdown-item dropdown-item--highlight" href="{{ route('admin.my-orders')}}"><span class="dropdown-item_label">Objednávky</span></a></li>
                                        <li class="dropdown-item-wrap"><a class="dropdown-item dropdown-item--highlight" href="{{ route('admin.orders-items') }}"><span class="dropdown-item_label">Položky objednávek</span></a></li>
                                        <li class="dropdown-item-wrap"><a class="dropdown-item dropdown-item--highlight" href="{{ route('admin.my-invoices')}}"><span class="dropdown-item_label">Faktury</span></a></li>
                                    ...
                                    <ul class="dropdown-menu-group">
                                        ...
                                        <li class="dropdown-item-wrap"><a class="dropdown-item" href="{{ route('admin.statistics-sales-by-category') }}"><span class="dropdown-item_label">Statistika prodeje</span></a></li>
                                        ...
                                        <li class="dropdown-item-wrap"><a class="dropdown-item" href="{{ route('admin.my-complaints') }}"><span class="dropdown-item_label">Reklamace</span></a></li>
                                        <li class="dropdown-item-wrap"><a class="dropdown-item" href="{{ route('admin.credit-note') }}"><span class="dropdown-item_label">Dobropisy</span></a></li> 
                                        ...
                                        <li class="dropdown-item-wrap"><a class="dropdown-item" href="{{ route('admin.my-settings') }}"><span class="dropdown-item_label">Moje nastavení</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="headerBasket" class="basket-header">
                        ...
                        <div id="basketsList" class="baskets-list">
                            ...
                            <div class="dropdown">
                                <button type="button" id="basketsList_btnToggle" class="btn dropdown-toggle baskets-list_btn-toggle" data-label="Zobrazit seznam košíků" onclick="GAAction(10,0,$(this));">
                                    <i id="basketsList_preloader" class="icon-folder"></i>
                                </button>
                            </div>
                            <div id="basketsList_overviewBox" class="dropdown-menu baskets-list_overview-box" aria-labelledby="basketsList">
                                <div class="dropdown-buttons dropdown-buttons--is-top">
                                    <div class="dropdown-buttons_btn-item">
                                        <button id="basketsList_btnBaskets" type="button" class="btn dropdown-buttons_btn baskets-list_btn baskets-list_btn--ovrw-baskets selected" data-type-basket="0" onclick="Header.basketsList_control.open(0);">
                                            <span class="btn_label">Přehled košíků</span>
                                        </button>
                                    </div>
                                    <div class="dropdown-buttons_btn-item">
                                        <button id="basketsList_btnOffers" type="button" class="btn dropdown-buttons_btn baskets-list_btn baskets-list_btn--ovrw-offers" data-type-basket="1" onclick="Header.basketsList_control.open(1);">
                                ...
                                <div class="dropdown-item baskets-list_item baskets-list_item--btn-show-add-form">
                                    <button id="basketsList_btnShowAddForm" type="button" class="baskets-list_btn-show-add-form" onclick="GAAction(10,0,$(this));Header.basketsList_control.toggleShowAddForm();">
                                    ...
                                    <form id="basketsList_addForm" class="baskets-list_add-form">
                                        <div class="form-group">
                                            <input id="basketsList_addForm_inp" type="text" class="form-control" placeholder="Zadejte název nového košíku" onkeypress="if (event.which == 13) {event.preventDefault(); Header.basketsList_control.addNewBasket();}">
                                        </div>
                                        <div class="buttons-area">
                                            <button type="button" class="btn baskets-list_add-form_btn baskets-list_add-form_btn--close" data-title="tip_cancel" onclick="Header.basketsList_control.toggleShowAddForm();">
                                                <i class="btn_icon icon-close"></i>
                                                <span class="btn_label">Zrušit</span>
                                            </button>

                                            <button type="button" class="btn baskets-list_add-form_btn baskets-list_add-form_btn--add" data-title="tip_insert" onclick="Header.basketsList_control.addNewBasket();">
                                                <i class="btn_icon icon-plus"></i>
                                ...
                                <div class="dropdown-buttons">
                                    <div class="dropdown-buttons_btn-item">
                                        <a href="/pages/administration/basketadmin.aspx" id="basketsList_btnGoAdmin" class="btn dropdown-buttons_btn baskets-list_btn baskets-list_btn--go-admin" onclick="GAAction(10,0,$(this));">
                        ...
                        <div id="basketInfo" class="basket-info">
                            <div class="dropdown">
                                <a href="{{ route('shopping-cart') }}" id="basketInfo_btnToggle" class="btn dropdown-toggle basket-info_btn-toggle">
                                    <i id="basketInfo_preloader" class="icon-basket icon-basket-info_btn-toggle"></i>

                                    <span id="basketInfo_itemsCount" class="badge badge--primary basket-info_items-count">{{ $itemCount }}</span>

                                    <span id="basketInfo_price" class="basket-info_price">{{ number_format($total,2,',',' ') }} Kč</span>
                                    <span class="dropdown-caret"></span>
                                </a>
                            </div>
                        </div>
            ...
            @else
                <div class="page-header_item">
                    ...
                    <div id="headUserMenu" class="head-user-menu">
                        ...
                        <a href="{{ url(env('APP_URL').'admin/register') }}" type="button" class="btn btn--other btn-user-login user-info">
                ...
                <nav class="head-nav_in" role="navigation" aria-label="Hlavní navigace">
                    <ul class="head-nav_group head-nav_group--level-1 level-1" role="menu">
                        ...
                        @foreach($categories as $category)
                            <li class="head-nav_item head-nav_item--level-1 head-nav_item--it-products has-childs head-nav_item--has-childs is-current-floor is-current">
                                <div class="nav-link-wrap head-nav_link-wrap">
                                    <a class="nav-link head-nav_link head-nav_link--level-1 head-nav_link--has-childs head-nav_link--is-current head-nav_link{{ $category->background }}" onclick="extAction(1,1,$(this));" data-nav-id="52" href="{{ route('category.root',['RootCategoryCode' => $category->SuperCategoryCode,'RootCategoryName' => $category->SuperCategoryName]) }}">
                                ...
                                <div class="sub-menu head-nav_sub-menu head-nav_sub-menu--level-1 head-nav_sub-menu{{ $category->background }}">
                                    ...
                                    <ul class="level-2 head-nav_group head-nav_group--level-2">
                                        ...
                                        @foreach($category->children as $subcategory)
                                            <li class="head-nav_item head-nav_item--level-2 has-childs head-nav_item--has-childs">
                                                <div class="nav-link-wrap head-nav_link-wrap">
                                                    <a class="nav-link head-nav_link nav-link head-nav_link--level-2 head-nav_link--has-childs" href="{{ route('category.super',['RootCategoryCode' => $category->SuperCategoryCode,'SuperCategoryCode' => $subcategory->SuperCategoryCode,'SuperCategoryName' => $subcategory->SuperCategoryName]) }}">
                                                            ...
                                                            @if($firstCategory && $firstCategory->ImageList)
                                                                <img style="width: 22%" class="head-nav_link-media head-nav_link-media--img"
                                                                     src="{{ $firstCategory->ImageList }}"
                                                                     alt="{{ $firstCategory->CategoryName }}">
                                                            @endif
                                                        <span class="head-nav_link-label">{{ $subcategory->SuperCategoryName }}</span>
                                                    </a>
                                                ...
                                                <div class="sub-menu head-nav_sub-menu head-nav_sub-menu--level-2">
                                                    <button type="button" class="btn btn-sub-menu-close head-nav_sub-menu_btn-close" onclick="MainMenu.navChildClose($(this).closest('li'));">
                                                        <i class="icon-arrow_left btn_icon"></i>
                                                        <span class="btn_label">{{ $subcategory->SuperCategoryName }}</span>
                                                    </button>
                                                    <ul class="level-3 head-nav_group head-nav_group--level-3">
                                                        ...
                                                        @foreach($subcategory->childrenCategory as $item)
                                                            <li data-menu-pnc="115" data-menu-pnsub="11" class="head-nav_item head-nav_item--level-3 has-childs head-nav_item--has-childs has-childs head-nav_item--has-childs">
                                                                ...
                                                                <div class="nav-link-wrap head-nav_link-wrap">
                                                                    <a class="nav-link head-nav_link head-nav_link--level-3 has-childs head-nav_link--has-childs" onclick="extAction(1,2,$(this));" data-nav-id="115" href="{{ route('category',['RootCategoryCode' => $category->SuperCategoryCode,'SuperCategoryCode' => $subcategory->SuperCategoryCode,'CategoryName' => $item->CategoryName, 'CategoryCode' => $item->CategoryCode]) }}">
                                                                        <span class="head-nav_link-label"> {{$item->CategoryName ." | "}}</span>
                                                                    </a>
                        ...
                        <li class="head-nav_item head-nav_item--level-1 head-nav_item--invisible">
                            <div class="nav-link-wrap head-nav_link-wrap">
                                <a class="nav-link head-nav_link head-nav_link--level-1" onclick="GAAction(5,0,$(this));" href="/pages/panelnavigatorvendor.aspx">
                        ...
                        <li class="head-nav_item head-nav_item--level-1 head-nav_item--invisible">
                            <div class="nav-link-wrap head-nav_link-wrap">
                                <a class="nav-link head-nav_link head-nav_link--level-1" onclick="GAAction(5,0,$(this));" href="/pages/productindexlist.aspx">
                        ...
                        <li class="head-nav_item head-nav_item--level-1 head-nav_item--invisible">
                            <div class="nav-link-wrap head-nav_link-wrap">
                                <a class="nav-link head-nav_link head-nav_link--level-1" onclick="GAAction(5,0,$(this));" href="/pages/productlist.aspx?vyhnab=1">
                        ...
                        <li class="head-nav_item head-nav_item--level-1 head-nav_item--invisible">
                            <div class="nav-link-wrap head-nav_link-wrap">
                                <a class="nav-link head-nav_link head-nav_link--level-1" onclick="GAAction(5,0,$(this));" href="/pages/specialdealprices.aspx">
