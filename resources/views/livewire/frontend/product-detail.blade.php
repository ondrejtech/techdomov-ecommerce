        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Přihlášení vyžadováno</h1>
                                                ...
                                                <div class="form-base_row">
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            @error('ico') <div class="text-danger small">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                    ...
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="companyName" type="text"
                                                                maxlength="100" id="txtLegalName" class="form-control">
                                                            @error('companyName') <div class="text-danger small">{{
                                                                $message }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="dic" type="text" id="txtLegalDIC"
                                                                class="form-control" maxlenglabel="20">
                                                            @error('dic') <div class="text-danger small">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-base_row">
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            @error('street') <div class="text-danger small">{{ $message
                                                                }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="city" type="text" maxlength="100"
                                                                id="txtLegalCity" class="form-control">
                                                            @error('city') <div class="text-danger small">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-base_row">
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="zip" type="text" maxlength="7"
                                                                id="txtLegalZip" class="form-control">
                                                            @error('zip') <div class="text-danger small">{{ $message }}
                                                            </div> @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <select wire:model.defer="country"
                                                                id="MainContent_ddLegalCountry" class="form-control">
                                                                <option value="Czech Republic" selected>Czech Republic
                                                                </option>
                                                                <option value="Slovakia">Slovakia</option>
                                                            </select>
                                                            @error('country') <div class="text-danger small">{{ $message
                                                                }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="firstName" type="text"
                                                                maxlength="20" id="txtPersonFName" class="form-control">
                                                            @error('firstName') <div class="text-danger small">{{
                                                                $message }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="lastName" type="text"
                                                                maxlength="100" id="txtPersonLName"
                                                                class="form-control">
                                                            @error('lastName') <div class="text-danger small">{{
                                                                $message }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-base_row form-base_row--align-v-top">
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="phone" type="text" maxlength="20"
                                                                id="txtLegalTel" class="form-control">
                                                            @error('phone') <div class="text-danger small">{{ $message
                                                                }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            @enderror
                                                            <small class="form-control-info">Kontaktní/přihlašovací
                                                                e-mail</small>
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="password" type="password"
                                                                maxlength="100" id="password" class="form-control">
                                                            @error('password') <div class="text-danger small">{{
                                                                $message }}</div>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="form-base_item">
                                                        <div class="form-group">
                                                            ...
                                                            <input wire:model.defer="confirm_password" type="password"
                                                                maxlength="100" id="confirm_password"
                                                                class="form-control">
                                                            @error('confirm_password') <div class="text-danger small">{{
                                                                $message }}
                                                            </div> @enderror
                                            ...
                                            <div class="form-base">
                                                <div class="form-base_item">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea wire:model.defer="note" rows="4" cols="20"
                                                            id="txtLegalNote" class="form-control"></textarea>
                                                        @error('note') <div class="text-danger small">{{ $message }}
                                                        </div> @enderror
                                                    </div>
                                                </div>
                                            </div>
        ...
        <article class="pro-detail pro-detail--has-gallery">
                    ...
                    <div class="pro-detail_aside-in">
                        ...
                        <div class="pro-detail_attributes">
                            ...
                            <a href="#" onclick="openTabCampaigns(this);" data-targetid="linkCampaigns">
                                <strong class="pro-attr pro-attr--special-offer-6 pro-attr--spo pro-detail_attr">
                                    <i class="pro-attr_icon icon-prod-attr-offer"></i>
                        ...
                        <figure class="pro-detail_head-img">
                            <a href="{{ optional($product->images->first())->URL ?? asset('images/no_image.jpg') }}"
                                title="Pro větší náhled klikněte na obrázek" data-title="{{ $product->Name }}"
                                data-fancybox-group="gallery"
                                data-thumbnail="{{ optional($product->images->first())->URL ?? asset('images/no_image.jpg') }}"
                                style="width: 100%" data-itemindex="0" class="fancybox fn-detail-pic">
                                        ...
                                        <div class="owl-item active" style="width: 220px;">
                                            <div class="pro-detail_gallery_item">
                                                <a href="{{ $image->URL ?? asset('images/no_image.jpg') }}"
                                                    ...
                                                    data-title="{{ $product->Name }}" data-fancybox-group="gallery"
                                                    data-thumbnail="{{ $image->URL ?? asset('images/no_image.jpg') }}"
                                                    style="width: 100%" data-itemindex="1"
                                                    ...
                                                    <img class="owl-lazy pro-img"
                                                        ...
                                                        alt="{{ $product->Name }}" style="opacity: 1; width: 100%;">
                                                </a>
                                            </div>
                                        </div>
                                        @endforeach
                                    ...
                                    <div class="panel-body">
                                        <div class="pro-detail_content">
                                            <div class="pro-detail_your-price-info">
                                                <div class="pro-detail_your-price">
                                                    ...
                                                    <strong class="pro-detail_your-price-value">
                                                        {{ number_format($product->YourPriceWithFees,2,',',' ')
                                                        }}&nbsp;Kč
                                                    </strong>
                                                </div>
                                                <div class="pro-detail_basket-info">
                                                    ...
                                                    <div class="pro-detail_order-box">
                                                        ...
                                                        <a class="btn pro-detail_btn-add-basket btn-add-basket"
                                                            ...
                                                            wire:click.prevent="addNewBasket" href=""><i
                                            ...
                                            <div class="pro-detail_interactive-section">
                                                ...
                                                <div id="product-special-prices" class="pro-detail_special-prices">
                                                    <link
                                                        href="https://edshopb2b.edsystem.cz/assets/bundles/css/documents?v=mDn5P7GBg7XiLCm8FHe3BLYNrS8_ywCTUVnewMn3Ai81"
                                                        rel="stylesheet">
                                                    {{-- <script--}} {{--
                                                        src="https://edshopb2b.edsystem.cz/assets/bundles/js/documentslist?v=K-KnBu2piVfKKq7KNYpiXRafHF1WH780L4sPGaRBk4o1">
                                                        </script>--}}
                                                        {{-- <div class="product-special-prices-wrapper">--}}
                                                            {{-- <a class="product-special-prices-btn btn btn--outline"
                                                                ...
                                                                {{-- <i
                                                                    class="icon-handshake pro-detail_btn-icon"></i>--}}
                                ...
                                {{-- <div class="pro-detail_link">--}}
                                    {{-- <a class="js-tooltip dasa-link" href="https://www.itdasa.cz/" --}} {{--
                                        ...
                                        {{-- <img style="height: 10px;margin-right:5px;" --}} {{--
                                            src="/Images/loga/dasa_logo.svg" alt="DaaS">
                                        <span--}} {{-- class="btn_label">Objednat přes službu DaaS</span>--}}
                                            {{--
                                    </a>--}}
                                    {{-- </div>--}}
                            </div>
                            ...
                            <div class="pro-detail_price-info">
                                <div class="panel-body">
                                    <div class="pro-detail_price-info_wrapper">
                                        ...
                                        <ul class="list-items collapse list-items--full" id="proDetail_PriceList">
                                            {{-- <li class="pro-detail_list-item">--}}
                                                {{-- <span--}} {{-- class="list-items_item_label">Koncová cena pro
                                                    klienta:</span>--}}
                                                    {{-- <div class="list-items_item_value">--}}
                                                        {{-- 44 807,00&nbsp;Kč--}}
                                                        {{-- </div>--}}
                            ...
                            <div class="panel-body">
                                <div class="pro-detail_code-info">
                                    ...
                                    <div class="pro-detail_info-item">
                                        ...
                                        <div class="list-items_item_value"><a href="#"
                                                onclick="openProducerInfo(1713260);return false;"></a>
                                        </div>
                                    </div>
                                    <div class="pro-detail_info-item">
            ...
            <div class="panel-tabs pro-detail_more-info js-tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
                <ul style="cursor: pointer"
                    class="nav nav-tabs pro-detail_tabs ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all"
                    role="tablist">
                    @foreach($productDetailTabs as $index => $productDetailTab)
                    <li wire:click.prevent="setActiveTab({{ $index }})"
                        class="nav-item ui-state-default ui-corner-top ui-tabs-active ui-state-active">
                        <a class="nav-link ui-tabs-anchor {{ $activeTab == $index ? 'nav-link--active' : '' }}">{{
                            $productDetailTab }}</a>
                    </li>
                    @endforeach
                </ul>
                ...
                <div class="panel pro-detail_tabs-panel">
                    <div class="panel-body">
                        ...
                        <div id="tabPanel1" aria-labelledby="ui-id-2"
                            ...
                            style="{{ $activeTab == $index ? 'display: block;' : 'display: none' }}">
                                ...
                                <div class="panel pro-detail_params-list">
                                    <div class="panel-body">
                                        ...
                                        <ul class="pro-detail_params-list_items">
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Výkon CPU dle
                                                    PassMark:</span>
                                                25&nbsp;029
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Maximální frekvence
                                                    procesoru (GHz):</span>
                                                4,9
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Frekvence procesoru
                                                    (GHz):</span>
                                                3,8
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Model grafické
                                                    karty:</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Kapacita paměti grafické
                                                    karty (GB):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Velikost paměti RAM
                                                    (GB):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Úhlopříčka displeje
                                                    ("):</span>
                                                14
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Rozlišení
                                                    displeje:</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Obnovovací frekvence
                                                    displeje (Hz):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Povrchová úprava
                                                    displeje:</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">HDD Kapacita
                                                    (GB):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">SSD Kapacita
                                                    (GB):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Počet USB 3.1
                                                    Type-C:</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Počet USB 3.2
                                                    Type-C:</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Počet USB 4
                                                    Type-C:</span>
                                                2
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Hmotnost
                                                    notebooku:</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Max.výdrž na baterie (v
                                                    hodinách):</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Kapacita baterie
                                                    (mAh):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Napětí baterie
                                                    (V):</span>
                                                0
                                            </li>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Počet článků
                                                    baterie:</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Lokalizace
                                                    klávesnice:</span>
                                            ...
                                            <li class="pro-detail_params-list_item">
                                                <span class="pro-detail_params-list_item_label">Druh optické
                                                    mechaniky:</span>
                            ...
                            <div class="pro-detail_more-info_wrap">
                                <div class="more-details">
                                    <table class="table table--auto documents-tbl-list">
                                        <thead>
                                            <tr>
                                                <th class="table-head-cell table-col_desc" data-touchtable-el="true">Typ
                                                    balení</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="suda">
                                                ...
                                                <td data-th="Šířka (cm)" class="table-col_dimension">{{
                                                    $logisticData->length }}</td>
                                                <td data-th="Výška (cm)" class="table-col_dimension">{{
