...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-LDG7H0P744"></script>
    <script>
       window.dataLayer = window.dataLayer || [];
       function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

         gtag('config', 'G-LDG7H0P744');
    </script>
    ...
    <link href="https://edshopb2b.edsystem.cz/assets/bundles/css/default?v=pkmhn1X8gtn1gknA5Wb1odRig2TBkoE2_ErtFriN6ZI1"
        rel="stylesheet" />

    <script
        src="https://edshopb2b.edsystem.cz/assets/bundles/js/default?v=liLF6iyFPSAG1FthyjB3DhBy22vjrP_Fd6HG92tjHB41">
    </script>
...
<body>
    ...
    <script>
        ...
        function GAAction(category, prefix, obj) {
            ...
            var gaString = onclick =
                "ga('send','event','#CATEGORY#','Click','#PREFIX##LABEL#',2, {'dimension1' : '1440560 - Mgr. Radka Staszko Pondělíková'});ga('send','pageview');";
            ...
            //alert(gaString);
            gaString = gaString.replace("#LABEL#", jsCorrect($.trim(gaLabel)).replace("\"", "")).replace("#CATEGORY#",
                GACategoryName(category)).replace("#PREFIX#", GACategoryLevelPrefix(prefix));
            //alert(gaString);
            eval(gaString);
        }
    </script>
