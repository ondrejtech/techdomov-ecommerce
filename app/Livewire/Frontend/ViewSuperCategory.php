...
class ViewSuperCategory extends Component
{
    use WithPagination;
    public $products;
    ...
    {
        $categoryCode = request()->route()->SuperCategoryCode;
        $superCategory = Category::where('SuperCategoryCode', $categoryCode)->get();
//        dd($superCategory->pluck('CategoryCode'));
        $paginator = Product::whereIn('CategoryCode', $superCategory->pluck('CategoryCode'))
    ...
    {
        return view('livewire.frontend.view-super-category');
    }
